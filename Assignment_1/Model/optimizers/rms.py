...
class RMSPropSolver:
    ...
    def step(self):
        ...
        for module in self.modules:
            ...
            module.G_squared_moving_avg = self.beta * module.G_squared_moving_avg + (1 - self.beta) * np.mean(np.square(module.G), axis=0)
            ...
            module.W = module.W - self.learning_rate * np.mean(module.G, axis=0) / np.sqrt(module.G_squared_moving_avg + self.epsilon)
            pass
        pass
    pass
